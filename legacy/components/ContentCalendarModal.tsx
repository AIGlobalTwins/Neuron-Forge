...
export function ContentCalendarModal({ onClose }: Props) {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto fade-up">
      <div className="w-full max-w-5xl bg-[#0d0d0d] border border-[#1e1e1e] rounded-2xl overflow-hidden shadow-2xl flex flex-col">
          ...
          {step === "loading" && (
            <div className="px-6 py-16 flex flex-col items-center gap-6">
              ...
              <div className="text-center space-y-1">
                ...
                <p className="text-gray-600 text-xs">AI is planning your month...</p>
              </div>
