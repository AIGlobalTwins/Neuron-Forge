...
export const DESIGN_TYPES: DesignType[] = [
  ...
  },
  {
    ...
    descPt: "Paper, serif alto-contraste + script, atemporal",
    theme: "light",
    fonts: { heading: "Playfair Display", body: "Lora", import: gf("family=Playfair+Display:wght@400;500;600;700&family=Lora:wght@400;500&family=Pinyon+Script") },
    palette: { primary: "#1a1a1a", accent: "#9a6a4a", bg: "#faf8f4", text: "#1a1a1a" },
    spacingScale: "generous",
    cornerRadius: "soft",
    styleQuery: "Editorial Grid Magazine elegant serif",
    typographyQuery: "Classic Elegant Playfair",
    vibeKeywords: "elegant refined timeless wedding fashion editorial serif script",
    principles: [
      "Timeless, restrained palette: paper / off-white canvas (#FAF8F4), near-black ink, a single muted terracotta-bronze accent (#9A6A4A)",
      "Elegant high-contrast display SERIF (Playfair Display) with ligatures/swashes as the hero word; wide letter-spacing on small-caps eyebrows (EST. 2021)",
      "ONE accent word or phrase set in a refined SCRIPT (Pinyon Script) in the accent colour — wedding / fashion feel",
      "Classic editorial layout: generous whitespace, hairline rules, small-caps labels, centred or gently asymmetric compositions",
      "Refined photography (muted or black & white) with subtle botanical touches; no bright colours, no heavy shadows",
      "Sophistication comes from type contrast (serif + script) and restraint",
    ],
    swatch: ["#1a1a1a", "#9a6a4a", "#faf8f4"],
  },
  {
    id: "luxury",
    label: "Luxury",
  ...
  },
  {
    ...
    descPt: "Near-black, glow âmbar, sans bold, dramático",
    theme: "dark",
    fonts: { heading: "Sora", body: "Manrope", import: gf("family=Sora:wght@400;500;600;700;800&family=Manrope:wght@300;400;500;600") },
    palette: { primary: "#f5f5f4", accent: "#f59e0b", bg: "#0a0a0b", text: "#f5f5f4" },
    spacingScale: "generous",
    cornerRadius: "soft",
    styleQuery: "Dark premium dramatic glow product",
    typographyQuery: "modern geometric sans",
    vibeKeywords: "dark dramatic premium glow amber product cinematic",
    principles: [
      "Dark canvas (near-black #0A0A0B), elevated surfaces #15120E; ONE vivid accent with a warm amber/orange GRADIENT GLOW (#F59E0B) bleeding behind the hero",
      "Bold modern sans headlines (Sora), high-contrast white text; muted secondary text (#A1A1AA)",
      "Premium product / dashboard energy: dark rounded cards (white/8 borders, soft inner glow), the accent on prices, CTAs and badges",
      "Dramatic cinematic imagery (product on dark, spotlight, smoke); subtle gradient accents",
      "Restraint elsewhere — the glow and one accent carry it; no rainbow, no pastel washes",
      "Optional bracket stat callouts ({15000+}) and an italic-serif accent word for contrast",
    ],
    swatch: ["#0a0a0b", "#f59e0b", "#15120e"],
  },
  {
    id: "pixel",
    label: "Pixel",
